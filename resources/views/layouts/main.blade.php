    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-1">
        ...
        <div class="w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 items-center">
                <li>
                    <a href="{{ route('main') }}" class="block py-2 px-3 {{ request()->is('/') ? 'text-my-oran-l' : 'text-gray-200' }} md:hover:text-my-oran-l md:bg-transparent md:p-0 dark:text-white md:dark:text-blue-500" >
                        Главная</a>
                </li>
                <li>
